...
import com.workflow.pro.common.aop.annotation.Repeat;
...
public class RepeatAspect extends HandlerInterceptorAdapter {
     ...
     * 切 面 编 程
     * */
    @Pointcut("@annotation(com.workflow.pro.common.aop.annotation.Repeat) || @within(com.workflow.pro.common.aop.annotation.Repeat)")
