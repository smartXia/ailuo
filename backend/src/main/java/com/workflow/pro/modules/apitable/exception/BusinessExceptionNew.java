...
package com.workflow.pro.modules.apitable.exception;
...
public class BusinessExceptionNew extends RuntimeException {
    ...
    public BusinessExceptionNew(BaseException exception, Map<String, Object> body) {
    ...
    public BusinessExceptionNew(int code, String message) {
        super(message);
        this.code = code;
    }

    public BusinessExceptionNew(int code, String msgFormat, Object... args) {
        super(String.format(msgFormat, args));
        this.code = code;
    }

    public BusinessExceptionNew(BaseException exception) {
        super(exception.getMessage());
        this.code = exception.getCode();
        this.fixedCode = exception.toString();
    }

    public BusinessExceptionNew(int code, String message, Object data) {
        super(message);
        this.code = code;
    }
