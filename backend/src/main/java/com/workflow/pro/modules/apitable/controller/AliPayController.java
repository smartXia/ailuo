...
import com.workflow.pro.common.aop.annotation.rest.AnonymousGetMapping;
...
public class AliPayController {
    ...
    @GetMapping
    public ResponseEntity<ToolAlipayConfig> queryAliConfig() {
    ...
    @ApiOperation("配置支付宝")
    @PutMapping
    public Result<Object> updateToolAlipayConfig(@Validated @RequestBody ToolAlipayConfig ToolAlipayConfig) {
        alipayService.config(ToolAlipayConfig);
        return Result.success(ToolAlipayConfig);
