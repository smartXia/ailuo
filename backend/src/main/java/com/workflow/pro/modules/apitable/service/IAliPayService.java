 ...
 * @date 2018-12-31
 */
public interface IAliPayService extends IService <ToolAlipayConfig>{

    /**
     * 查询配置
     * @return ToolAlipayConfig
     */
    ToolAlipayConfig find();

    /**
     * 更新配置
     * @param ToolAlipayConfig 支付宝配置
     * @return ToolAlipayConfig
     */
    ToolAlipayConfig config(ToolAlipayConfig ToolAlipayConfig);
