...
import { page, remove, removeBatch } from "@/api/module/toolEmailConfig";
...
export default {
  ...
  setup() {
    ...
    const columns = [
                    ...
                    { dataIndex: "fromUser", key: "fromUser", title: "收件人" },
                                                                                            
                    { dataIndex: "host", key: "host", title: "邮件服务器SMTP地址" },
                                                                                            
                    { dataIndex: "pass", key: "pass", title: "密码" },
                                                                                            
                    { dataIndex: "port", key: "port", title: "端口" },
                                                                                            
                    { dataIndex: "user", key: "user", title: "发件者用户名" },
                      ];
