...
import { page, remove, removeBatch } from "@/api/module/toolAlipayConfig";
...
export default {
  ...
  setup() {
    ...
    const columns = [
                    ...
                    { dataIndex: "configId", key: "configId", title: "ID" },
                                                                                            
                    { dataIndex: "appId", key: "appId", title: "应用ID" },
                                                                                            
                    { dataIndex: "charset", key: "charset", title: "编码" },
                                                                                            
                    { dataIndex: "format", key: "format", title: "类型 固定格式json" },
                                                                                            
                    { dataIndex: "gatewayUrl", key: "gatewayUrl", title: "网关地址" },
                                                                                            
                    { dataIndex: "notifyUrl", key: "notifyUrl", title: "异步回调" },
                                                                                            
                    { dataIndex: "privateKey", key: "privateKey", title: "私钥" },
                                                                                            
                    { dataIndex: "publicKey", key: "publicKey", title: "公钥" },
                                                                                            
                    { dataIndex: "returnUrl", key: "returnUrl", title: "回调地址" },
                                                                                            
                    { dataIndex: "signType", key: "signType", title: "签名方式" },
                                                                                            
                    { dataIndex: "sysServiceProviderId", key: "sysServiceProviderId", title: "商户号" },
                      ];
