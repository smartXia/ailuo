...
import { page, remove, removeBatch } from "@/api/module/projectTechnicalProcess";
...
export default {
  ...
  setup() {
    ...
    const columns = [
                    ...
                    { dataIndex: "result", key: "result", title: "分析结果" },

                    { dataIndex: "selectionAnalysis", key: "selectionAnalysis", title: "选型分析" },

                    { dataIndex: "productionAnalysis", key: "productionAnalysis", title: "生产分析" },

                    { dataIndex: "attach", key: "attach", title: "附件" },

                    { dataIndex: "commitMsg", key: "commitMsg", title: "其他评论" },

                    { dataIndex: "linkSale", key: "linkSale", title: "关联报价" },
