...
import { page, remove, removeBatch } from "@/api/module/omsOrderOperateHistory";
...
export default {
  ...
  setup() {
    ...
    const columns = [
                    ...
                    { dataIndex: "operateMan", key: "operateMan", title: "操作人：用户；系统；后台管理员" },
                                                                                                            
                    { dataIndex: "orderStatus", key: "orderStatus", title: "订单状态：0->待付款；1->待发货；2->已发货；3->已完成；4->已关闭；5->无效订单" ,switch: switchFormat},
