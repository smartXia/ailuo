...
import { page, remove, removeBatch } from "@/api/order/omsOrderReturnApply";
...
export default {
  ...
  setup() {
    ...
    const columns = [
      ...
      { dataIndex: "productId", key: "productId", title: "退货商品id" },
      { dataIndex: "orderSn", key: "orderSn", title: "订单编号" },
      { dataIndex: "memberUsername", key: "memberUsername", title: "会员用户名" },
      { dataIndex: "returnAmount", key: "returnAmount", title: "退款金额" },
      { dataIndex: "returnName", key: "returnName", title: "退货人姓名" },
      { dataIndex: "returnPhone", key: "returnPhone", title: "退货人电话" },
      { dataIndex: "status", key: "status", title: "申请状态：0->待处理；1->退货中；2->已完成；3->已拒绝", switch: switchFormat },
      { dataIndex: "productName", key: "productName", title: "商品名称" },
      { dataIndex: "productPrice", key: "productPrice", title: "商品单价" },
      { dataIndex: "productRealPrice", key: "productRealPrice", title: "商品实际支付单价" },
      // { dataIndex: "reason", key: "reason", title: "原因" },
      // { dataIndex: "handleNote", key: "handleNote", title: "处理备注" },
    ];
