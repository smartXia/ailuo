...
import { page, remove, removeBatch } from "@/api/module/apitableInviteRecord";
...
export default {
  ...
  setup() {
    ...
    const columns = [
      ...
      { dataIndex: "inviter", key: "inviter", title: "邀请id" },
      { dataIndex: "accepter", key: "accepter", title: "成员id" },
      { dataIndex: "type", key: "type", title: "0: 邀请; 1: 文件导出; 2: 邀请链接" },
      { dataIndex: "content", key: "content", title: "内容" },
      { dataIndex: "sort", key: "sort", title: "排序" },
      { dataIndex: "ignoreMsg", key: "ignoreMsg", title: "忽略消息" },
    ];
