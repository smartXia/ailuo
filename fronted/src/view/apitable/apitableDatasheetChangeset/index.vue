...
import { page, remove, removeBatch } from "@/api/module/apitableDatasheetChangeset";
...
export default {
  ...
  setup() {
    ...
    const columns = [
                    ...
                    { dataIndex: "messageId", key: "messageId", title: "消息id" },
                                                                                            
                    { dataIndex: "dstId", key: "dstId", title: "表格id" },
                                                                                            
                    { dataIndex: "memberId", key: "memberId", title: "成员id" },
                                                                                            
                    { dataIndex: "operations", key: "operations", title: "操作动作集合" },
