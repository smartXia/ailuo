...
import { page, remove, removeBatch } from "@/api/module/sysUserGrade";
...
export default {
  ...
  setup() {
    ...
    const columns = [
      ...
      { dataIndex: "grade", key: "grade", title: "等级" },

      { dataIndex: "name", key: "name", title: "等级名称" },

      { dataIndex: "validDay", key: "validDay", title: "有效期" },

      { dataIndex: "price", key: "price", title: "价格" },

      { dataIndex: "image", key: "image", title: "展示图" },

      { dataIndex: "promotionPrice", key: "promotionPrice", title: "促销价格" },

      { dataIndex: "bindRole", key: "bindRole", title: "绑定角色" },

      // { dataIndex: "status", key: "status", title: "状态" ,switch: switchFormat},

      // { dataIndex: "sale", key: "sale", title: "销量" },

      // { dataIndex: "catchCondition", key: "catchCondition", title: "升级会员等级条件描述" },

      // { dataIndex: "catchType", key: "catchType", title: "升级会员等级条件，init:默认获取;pay:付费升级；frequency:消费次数；amount:累积消费金额升级" },

      // { dataIndex: "catchValue", key: "catchValue", title: "达到升级条件的值" },

      // { dataIndex: "userPrivilege", key: "userPrivilege", title: "会员权益描述" },

      // { dataIndex: "discount", key: "discount", title: "享受折扣" },

      // { dataIndex: "speed", key: "speed", title: "积分加速" },
