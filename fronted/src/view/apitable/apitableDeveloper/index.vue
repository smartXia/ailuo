...
import { page, remove, removeBatch } from "@/api/module/apitableDeveloper";
...
export default {
  ...
  setup() {
    ...
    const columns = [
      ...
      { dataIndex: "id", key: "id", title: "Primary Key" },

      { dataIndex: "dstId", key: "dstId", title: "表格id" },

      { dataIndex: "userId", key: "userId", title: "用户id" },

      { dataIndex: "allowManage", key: "allowManage", title: "管理" },

      { dataIndex: "allowWatch", key: "allowWatch", title: "查看" },

      { dataIndex: "allowEdit", key: "allowEdit", title: "编辑" },

      { dataIndex: "allowSave", key: "allowSave", title: "保存记录" },

      { dataIndex: "apiKey", key: "apiKey", title: "开发者平台的唯一令牌" },

      { dataIndex: "enable", key: "enable", title: "是否开启" },
