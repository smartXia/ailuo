...
import { page, remove, removeBatch } from "@/api/module/apitableDatasheet";
...
export default {
  ...
  setup() {
    ...
    const columns = [
                    ...
                    { dataIndex: "dstId", key: "dstId", title: "dstId" },

                    { dataIndex: "nodeId", key: "nodeId", title: "节点id" },

                    { dataIndex: "dstName", key: "dstName", title: "表格名" },

                    { dataIndex: "spaceId", key: "spaceId", title: "工作空间" },

                    { dataIndex: "revision", key: "revision", title: "版本号" },
    ...
    const searchParam = [
      { key: "dstId", type: "input", label: "节点id" },
      { key: "isDeveloper", type: "input", label: "协作的文章" },
    ]
