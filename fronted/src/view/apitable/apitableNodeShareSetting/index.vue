...
import { page, remove, removeBatch } from "@/api/module/apitableNodeShareSetting";
...
export default {
  ...
  setup() {
    ...
    /// 列配置
    const columns = [
                    { dataIndex: "dstId", key: "dstId", title: "数据id" },
                    { dataIndex: "shareId", key: "shareId", title: "分享标识" },
                    { dataIndex: "isEnabled", key: "isEnabled", title: "分享状态 (0: off, 1: on)" },
                    { dataIndex: "allowSave", key: "allowSave", title: "允许保存 (0: No, 1: Yes)" },
                    { dataIndex: "allowEdit", key: "allowEdit", title: "允许编辑(0: No, 1: Yes)" },
                    { dataIndex: "props", key: "props", title: "分享属性" },
                      ];
