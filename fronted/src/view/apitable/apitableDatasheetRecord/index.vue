...
import { page, remove, removeBatch } from "@/api/module/apitableDatasheetRecord";
...
export default {
  ...
  setup() {
    ...
    const columns = [
                    ...
                    { dataIndex: "recordId", key: "recordId", title: "操作id" },

                    { dataIndex: "dstId", key: "dstId", title: "表格id" },

                    { dataIndex: "data", key: "data", title: "一行记录数据(对应于每个字段)" },

                    { dataIndex: "fieldUpdatedInfo", key: "fieldUpdatedInfo", title: "字段更新信息" },
                      ];
    ...
    const searchParam = [
      ...
      { key: "recordId", type: "input", label: "recordId" },
    ]
